...
class CAMBparams(F2003Class):
    ...
    _fields_ = (
        ...
        ("Axion", AllocatableObject(AxionModel), "AxiECAMB ultralight-axion component"),
    )
    ...
    def set_axion(self, m_ax, omaxh2=None, omdah2=None, axfrac=None, dfac=10.0):
        ...
        Use either an explicit axion density omaxh2 (with omch2 set as usual in
        set_cosmology), or the (omdah2, axfrac) parameterization where omdah2 is the
        total dark matter density and axfrac the axion fraction of the dark matter
        (or of the dark energy when m/H0 < 10); in that case omch2 is set internally.

        :param m_ax: axion mass in eV (negative input interpreted as log10(m_ax/eV))
        :param omaxh2: Omega_ax h^2
        :param omdah2: total dark matter Omega h^2 (used with axfrac)
        :param axfrac: axion fraction
        :param dfac: KG->EFA switch threshold m = dfac*H (default 10)
        """
        self.Axion.set_params(m_ax, omaxh2=omaxh2, omdah2=omdah2, axfrac=axfrac, dfac=dfac)
        return self
