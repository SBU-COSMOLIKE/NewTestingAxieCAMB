        ...
        associate(Params => State%CP)
            ...
            ELSE
                ...
                do itf = 1, CAMB_Pk%num_z
                    ...
                    if (State%HasAxion()) then
                        if (Params%Axion%is_de_like) then
                            !DE-like axion counted in the smooth dark energy (AxiECAMB halofit_ppf)
                            this%om_m = omega_m(a, this%omm0, State%omega_de + Params%Axion%omaxh2_eff/h2, &
                                this%w_hf, this%wa_hf)
                            this%om_v = omega_v(a, this%omm0, State%omega_de + Params%Axion%omaxh2_eff/h2, &
                                this%w_hf, this%wa_hf)
                        else
